...
<title>Insert title here</title>
    <style>
      ...
      #profilearea{top:25px;margin-left:1100px;height:15px;font-size:20px;} 
      #profilearea1{top:25px;margin-left:1200px;height:15px;font-size:20px;}
...
<body>
    ...
    <div class ="header">
		...
		<div id = "profilearea" class = "header"><a href ="EmployeeHomePage.jsp"><font color="white">Home</font></a></div>
		 <div id = "profilearea1" class = "header"><a href ="EmployeeLogOut"><font color="white">Logout</font></a></div>
    </div>
